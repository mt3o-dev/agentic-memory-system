...
| Human surface | `gui_api.py`, `gui/` | Minimal web GUI (Svelte + Bootstrap) for inspection, the human-in-the-loop checkpoints, privileged maintenance (bulk trust recompute), and a 3D force-directed graph view with node/edge editing ([`docs/11_GRAPH_VIEW.md`](docs/11_GRAPH_VIEW.md)) |
